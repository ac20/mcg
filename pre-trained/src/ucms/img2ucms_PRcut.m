...
% ------------------------------------------------------------------------
function [ucm2, ucms, elapsed_time] = img2ucms_PRcut(I, model, scales, all_parameters, param_multi, align_thr)
...
% globalization
[ sPb_thin] = PRcut(owt2 * mult_Pb, nvec, ic_gamma, dthresh) / sat_sPb; %**********
