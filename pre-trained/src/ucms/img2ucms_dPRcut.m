...
% ------------------------------------------------------------------------
function [ucm2, ucms, elapsed_time] = img2ucms_dPRcut(I, model, scales, all_parameters, param_multi, align_thr)
...
% globalization
[ sPb_thin] = spectralPb_fast3(owt2 * mult_Pb, nvec, ic_gamma, dthresh) / sat_sPb;
